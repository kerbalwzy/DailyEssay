...
- 难点: 如何保证不会添加出 `对同一个房间` 存在 `住房时间冲突` 的订单? 即假如想在我想入住 `007号房` ,想要入住时间是 `3月10日–3月20日` ,那么如果已经存在对这个 `007号房`的订单与我的想要入住的时间有重叠,那么我就不能成功下这个订单

- 分析:

  - ##### 1.查出这个007号房间的所有订单

  - ##### 2.在这些订单中找入住时间与我的入住时间存在重叠的订单,即冲突订单
